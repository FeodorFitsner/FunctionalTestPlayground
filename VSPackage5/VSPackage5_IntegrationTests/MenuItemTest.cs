...
namespace VSPackage5_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Company.VSPackage5.GuidList.guidVSPackage5CmdSet, (int)Company.VSPackage5.PkgCmdIDList.cmdidMyCommandTestTest);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "TestTestPkg", "Company.VSPackage5.VSPackage5Package");
