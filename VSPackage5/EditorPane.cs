...
namespace Company.VSPackage5
{
    ...
    //     - An empty vspackage5Test file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFileTest.vspackage5Test. Note this file name appears in Editor.vsdir
    ...
    //          - "MyExtFileTest" - This is the base file name. New files will initially
    //             be named as MyExtFileTest1.vspackage5Test, MyExtFileTest2.vspackage5Test... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFileTest.vspackage5Test|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFileTest.vspackage5Test - our empty vspackage5Test file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".vspackage5Test";
        ...
        #region Fields
        private VSPackage5Package myPackage;
        ...
        public EditorPane(VSPackage5Package package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the vspackage5Test document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(VSPackage5Package package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVSPackage5CmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVSPackage5CmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidVSPackage5EditorFactory;
            return VSConstants.S_OK;
        }
