...
namespace Company.VSPackage5
{
    ...
    /// </summary>
    [Guid(GuidList.guidVSPackage5EditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private VSPackage5Package editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(VSPackage5Package package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidVSPackage5EditorFactory;
            pgrfCDW = 0;
