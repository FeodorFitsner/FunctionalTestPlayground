...
using Company.VSPackage5;

namespace VSPackage5_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSPackage5Package() as IVsPackage;
            ...
            BaseMock registerEditor = VSPackage5_UnitTests.EditorTests.RegisterEditorsServiceMock.GetRegisterEditorsInstance();
            ...
            CommandID menuCommandID = new CommandID(Company.VSPackage5.GuidList.guidVSPackage5CmdSet, (int)Company.VSPackage5.PkgCmdIDList.cmdidMyCommandTestTest);
