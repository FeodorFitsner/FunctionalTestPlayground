...
namespace Company.VSPackage5
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".vspackage5Test", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "TestTestPkg")]
    [ProvideKeyBindingTable(GuidList.guidVSPackage5EditorFactoryString, 102)]
    ...
    public sealed class VSPackage5Package : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidVSPackage5CmdSet, (int)PkgCmdIDList.cmdidMyCommandTestTest);
